...
<div class="row g-4">
    <div class="col-md-3">
        ...
        <input type="file" name="logo" id="logo" class="form-control"
               value="{{ isset($property->logo_path) ? asset('storage/' . $property->logo_path) : '' }}"
               accept=".jpg,.jpeg,.png,.gif" onchange="previewLogo(this)">
        <img id="preview-logo"
             src="{{ isset($property->logo_path) ? asset('storage/' . $property->logo_path) : asset('assets/teste3.png') }}"
             class="preview-img mt-2" alt="Preview Logo">
        ...
        <div class="row g-3">
            ...
            <div class="col-md-4">
                ...
                <input type="text" name="whatsapp" id="whatsapp" class="form-control telefone"
                       value="{{ old('whatsapp', $property->whatsapp ?? '') }}" required>
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="instagram" id="instagram" class="form-control"
                       value="{{ old('instagram', ltrim($property->instagram ?? '', '@')) }}" required>
            </div>

            <div class="col-md-6">
                <label class="form-label">Endereço do Empreendimento *</label>
                <input type="text" name="endereco_principal" id="endereco_principal" class="form-control"
                       value="{{ old('endereco_principal', $property->endereco_principal ?? '') }}" required>
            </div>

            <div class="col-md-4">
                <label class="form-label">Link do Google Maps</label>
                <input type="url" name="google_maps_url" id="google_maps_url" class="form-control" required
            ...
            <div class="col-md-2">
                ...
                <input type="text" name="latitude" id="latitude" class="form-control"
                       value="{{ old('latitude', $property->latitude ?? '') }}" required placeholder="Latitude">
            </div>

            <div class="col-md-2">
                <label class="form-label">Longitude</label>
                <input type="text" name="longitude" id="longitude" class="form-control"
                       value="{{ old('longitude', $property->longitude ?? '') }}" required placeholder="Longitude">
            </div>
            ...
            <div class="col-md-4">
                ...
                <select name="cidade" id="cidade" class="form-select select2" required>
                    ...
                    @foreach($cidadesRJ as $cidade)
                        <option
                            value="{{ $cidade }}" @selected(old('cidade', $property->cidade ?? '') === $cidade)>{{ $cidade }}</option>
                    @endforeach
                </select>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col">
            ...
            <input type="text" name="nome_responsavel" id="nome_responsavel" class="form-control"
                   ...
                   value="{{ old('nome_responsavel', $property->nome_responsavel ?? '') }}"
                   required>
        </div>
        <div class="col">
            ...
            <input type="text" name="email_responsavel" id="email_responsavel" class="form-control"
                   value="{{ old('email_responsavel', $property->email_responsavel ?? '') }}"
    ...
    <div class="row g-3 mt-4">
        ...
        <div class="col-md-6">
            ...
            <select name="possui_acessibilidade" id="possui_acessibilidade" required class="form-select">
                <option value="1" @selected(old('possui_acessibilidade', $property->possui_acessibilidade ?? false))>
                    Sim
                </option>
                <option value="0" @selected(!old('possui_acessibilidade', $property->possui_acessibilidade ?? false))>
                    Não
                </option>
            </select>
        </div>
        ...
        imagensSalvas.forEach(img => {
            ...
            removeBtn.addEventListener('click', function () {
                ...
                fetch('/imagens/remover', {
                    ...
                    body: JSON.stringify({
                        id: img.id,
                        type: '{{ isset($property)?($property instanceof \App\Models\Property?'property':'preapproved_property'):'' }}'
                    })
                });
            });
