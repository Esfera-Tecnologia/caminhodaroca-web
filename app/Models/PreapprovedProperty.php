...
class PreapprovedProperty extends Model
{
    ...
    {
        return $this->belongsToMany(Category::class, 'category_preapproved_property_subcategories')
    ...
    {
        return $this->belongsToMany(Subcategory::class, 'category_preapproved_property_subcategories')
    ...
    {
        return $this->belongsToMany(Product::class, 'preapproved_property_product');
    }
